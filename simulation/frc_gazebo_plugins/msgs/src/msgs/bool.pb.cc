...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_bool_2eproto);
}
...
void protobuf_AddDesc_bool_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\nbool.proto\022\013gazebo.msgs\"\024\n\004Bool\022\014\n\004dat"
    "a\030\001 \002(\010B\010B\006GzBool", 57);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "bool.proto", &protobuf_RegisterTypes);
  Bool::default_instance_ = new Bool();
  Bool::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_bool_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_bool_2eproto {
  StaticDescriptorInitializer_bool_2eproto() {
    protobuf_AddDesc_bool_2eproto();
  }
} static_descriptor_initializer_bool_2eproto_;
...
Bool::Bool()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:gazebo.msgs.Bool)
}
...
Bool::Bool(const Bool& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:gazebo.msgs.Bool)
}
...
Bool::~Bool() {
  // @@protoc_insertion_point(destructor:gazebo.msgs.Bool)
  SharedDtor();
}
...
const Bool& Bool::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_bool_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Bool)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Bool)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Bool)
  return false;
#undef DO_
}
...
void Bool::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Bool)
  // required bool data = 1;
  if (has_data()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Bool)
}

::google::protobuf::uint8* Bool::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:gazebo.msgs.Bool)
  // required bool data = 1;
  if (has_data()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:gazebo.msgs.Bool)
  return target;
}
