...
void protobuf_AssignDesc_driver_2dstation_2eproto() {
  protobuf_AddDesc_driver_2dstation_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "driver-station.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_driver_2dstation_2eproto);
}
...
void protobuf_ShutdownFile_driver_2dstation_2eproto() {
  delete DriverStation::default_instance_;
  delete DriverStation_reflection_;
}

void protobuf_AddDesc_driver_2dstation_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024driver-station.proto\022\013gazebo.msgs\"z\n\rD"
    "riverStation\022\017\n\007enabled\030\001 \002(\010\022/\n\005state\030\002"
    " \002(\0162 .gazebo.msgs.DriverStation.State\"\'"
    "\n\005State\022\010\n\004AUTO\020\000\022\n\n\006TELEOP\020\001\022\010\n\004TEST\020\002B"
    "\021B\017GzDriverStation", 178);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "driver-station.proto", &protobuf_RegisterTypes);
  DriverStation::default_instance_ = new DriverStation();
  DriverStation::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_driver_2dstation_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_driver_2dstation_2eproto {
  StaticDescriptorInitializer_driver_2dstation_2eproto() {
    protobuf_AddDesc_driver_2dstation_2eproto();
  }
} static_descriptor_initializer_driver_2dstation_2eproto_;
...
DriverStation::DriverStation()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:gazebo.msgs.DriverStation)
}
...
DriverStation::DriverStation(const DriverStation& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:gazebo.msgs.DriverStation)
}
...
DriverStation::~DriverStation() {
  // @@protoc_insertion_point(destructor:gazebo.msgs.DriverStation)
  SharedDtor();
}
...
const DriverStation& DriverStation::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_driver_2dstation_2eproto();
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<DriverStation*>(16)->f) - \
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.DriverStation)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.DriverStation)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.DriverStation)
  return false;
#undef DO_
}
...
void DriverStation::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.DriverStation)
  // required bool enabled = 1;
  if (has_enabled()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.DriverStation)
}

::google::protobuf::uint8* DriverStation::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:gazebo.msgs.DriverStation)
  // required bool enabled = 1;
  if (has_enabled()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:gazebo.msgs.DriverStation)
  return target;
}
