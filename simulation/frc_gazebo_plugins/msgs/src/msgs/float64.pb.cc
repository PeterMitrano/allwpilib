...
void protobuf_AssignDesc_float64_2eproto() {
  protobuf_AddDesc_float64_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_float64_2eproto);
}
...
void protobuf_ShutdownFile_float64_2eproto() {
  delete Float64::default_instance_;
  delete Float64_reflection_;
}

void protobuf_AddDesc_float64_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rfloat64.proto\022\013gazebo.msgs\"\027\n\007Float64\022"
    "\014\n\004data\030\001 \002(\001B\013B\tGzFloat64", 66);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "float64.proto", &protobuf_RegisterTypes);
  Float64::default_instance_ = new Float64();
  Float64::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_float64_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_float64_2eproto {
  StaticDescriptorInitializer_float64_2eproto() {
    protobuf_AddDesc_float64_2eproto();
  }
} static_descriptor_initializer_float64_2eproto_;
...
Float64::Float64()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:gazebo.msgs.Float64)
}
...
Float64::Float64(const Float64& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:gazebo.msgs.Float64)
}
...
Float64::~Float64() {
  // @@protoc_insertion_point(destructor:gazebo.msgs.Float64)
  SharedDtor();
}
...
const Float64& Float64::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_float64_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gazebo.msgs.Float64)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gazebo.msgs.Float64)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gazebo.msgs.Float64)
  return false;
#undef DO_
}
...
void Float64::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gazebo.msgs.Float64)
  // required double data = 1;
  if (has_data()) {
  ...
  // @@protoc_insertion_point(serialize_end:gazebo.msgs.Float64)
}

::google::protobuf::uint8* Float64::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:gazebo.msgs.Float64)
  // required double data = 1;
  if (has_data()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:gazebo.msgs.Float64)
  return target;
}
