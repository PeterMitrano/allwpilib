...
@set gz_root_path=%home%\gz_ws\gazebo
@set gz_build_path=%gz_root_path%\build
@set deps_path=%home%\gz_ws
@popd
...
@set PATH=^
%home%\wpilib\cpp\current\lib\desktop;^
%home%\wpilib\cpp\current\sim\lib;^
%deps_path%\boost_1_56_0\lib64-msvc-12.0;^
