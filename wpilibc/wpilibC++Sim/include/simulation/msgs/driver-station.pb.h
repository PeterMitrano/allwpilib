...
#ifndef PROTOBUF_driver_2dstation_2eproto__INCLUDED
#define PROTOBUF_driver_2dstation_2eproto__INCLUDED
...
class DriverStation : public ::google::protobuf::Message {
 ...
 private:
  ...
  bool enabled_;
  int state_;
  friend void  protobuf_AddDesc_driver_2dstation_2eproto();
  friend void protobuf_AssignDesc_driver_2dstation_2eproto();
  friend void protobuf_ShutdownFile_driver_2dstation_2eproto();
...
inline bool DriverStation::enabled() const {
  // @@protoc_insertion_point(field_get:gazebo.msgs.DriverStation.enabled)
  return enabled_;
}
inline void DriverStation::set_enabled(bool value) {
  set_has_enabled();
  enabled_ = value;
  // @@protoc_insertion_point(field_set:gazebo.msgs.DriverStation.enabled)
}
...
inline ::gazebo::msgs::DriverStation_State DriverStation::state() const {
  // @@protoc_insertion_point(field_get:gazebo.msgs.DriverStation.state)
...
inline void DriverStation::set_state(::gazebo::msgs::DriverStation_State value) {
  ...
  set_has_state();
  state_ = value;
  // @@protoc_insertion_point(field_set:gazebo.msgs.DriverStation.state)
}
...
template <> struct is_proto_enum< ::gazebo::msgs::DriverStation_State> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_driver_2dstation_2eproto__INCLUDED
