...
#ifndef PROTOBUF_float64_2eproto__INCLUDED
#define PROTOBUF_float64_2eproto__INCLUDED
...
class Float64 : public ::google::protobuf::Message {
 ...
 private:
  ...
  double data_;
  friend void  protobuf_AddDesc_float64_2eproto();
  friend void protobuf_AssignDesc_float64_2eproto();
  friend void protobuf_ShutdownFile_float64_2eproto();
...
inline double Float64::data() const {
  // @@protoc_insertion_point(field_get:gazebo.msgs.Float64.data)
  return data_;
}
inline void Float64::set_data(double value) {
  set_has_data();
  data_ = value;
  // @@protoc_insertion_point(field_set:gazebo.msgs.Float64.data)
}
...
#endif  // PROTOBUF_float64_2eproto__INCLUDED
